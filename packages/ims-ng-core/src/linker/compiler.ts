...
const Compiler_compileModuleSync__PRE_R3__: <T>(
  moduleType: Type<T>,
) => NgModuleFactory<T> = _throwError as any;
export const Compiler_compileModuleSync__POST_R3__: <T>(
  moduleType: Type<T>,
...
const Compiler_compileModuleAsync__PRE_R3__: <T>(
  moduleType: Type<T>,
) => Promise<NgModuleFactory<T>> = _throwError as any;
export const Compiler_compileModuleAsync__POST_R3__: <T>(
  moduleType: Type<T>,
) => Promise<NgModuleFactory<T>> = function<T>(
  moduleType: Type<T>,
...
const Compiler_compileModuleAndAllComponentsSync__PRE_R3__: <T>(
  moduleType: Type<T>,
) => ModuleWithComponentFactories<T> = _throwError as any;
export const Compiler_compileModuleAndAllComponentsSync__POST_R3__: <T>(
  moduleType: Type<T>,
) => ModuleWithComponentFactories<T> = function<T>(
  moduleType: Type<T>,
...
const Compiler_compileModuleAndAllComponentsAsync__PRE_R3__: <T>(
  moduleType: Type<T>,
) => Promise<ModuleWithComponentFactories<T>> = _throwError as any;
export const Compiler_compileModuleAndAllComponentsAsync__POST_R3__: <T>(
  moduleType: Type<T>,
) => Promise<ModuleWithComponentFactories<T>> = function<T>(
  moduleType: Type<T>,
