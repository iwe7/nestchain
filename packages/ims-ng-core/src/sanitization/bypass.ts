...
export function allowSanitizationBypass(value: any, type: BypassType): boolean {
  return (
    value instanceof String && (value as TrustedStyleString)[BRAND] === type
  );
}
 ...
 */
export function bypassSanitizationTrustHtml(
  trustedHtml: string,
): TrustedHtmlString {
 ...
 */
export function bypassSanitizationTrustStyle(
  trustedStyle: string,
): TrustedStyleString {
 ...
 */
export function bypassSanitizationTrustScript(
 ...
 */
export function bypassSanitizationTrustUrl(
  trustedUrl: string,
): TrustedUrlString {
 ...
 * @returns a `url` `String` which has been branded to be implicitly trusted.
 */
export function bypassSanitizationTrustResourceUrl(
  trustedResourceUrl: string,
): TrustedResourceUrlString {
  return bypassSanitizationTrustString(
    trustedResourceUrl,
...
function bypassSanitizationTrustString(
  ...
  mode: BypassType.Html,
): TrustedHtmlString;
function bypassSanitizationTrustString(
  trustedString: string,
  mode: BypassType.Style,
): TrustedStyleString;
function bypassSanitizationTrustString(
  trustedString: string,
  mode: BypassType.Script,
): TrustedScriptString;
function bypassSanitizationTrustString(
  trustedString: string,
  mode: BypassType.Url,
