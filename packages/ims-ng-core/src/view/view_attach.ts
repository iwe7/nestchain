...
export function detachEmbeddedView(
  elementData: ElementData,
  viewIndex?: number,
): ViewData | null {
...
function renderAttachEmbeddedView(
  elementData: ElementData,
  prevView: ViewData | null,
  view: ViewData,
) {
  const prevRenderNode = prevView
    ? renderNode(prevView, prevView.def.lastRenderRootNode!)
