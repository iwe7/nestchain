...
import {
  ...
  isBrowserEvents,
  loadLContext,
  loadLContextFromNode,
} from '../render3/discovery_utils';
...
import {
  ...
  getValue,
  isClassBasedValue,
} from '../render3/styling/class_and_style_bindings';
...
class DebugNode__POST_R3__ implements DebugNode {
  ...
  get context(): any {
    return getContext(this.nativeNode as Element);
  }
...
export function getDebugNode__POST_R3__(
  nativeNode: Element,
 ...
 * @publicApi
 */
export const getDebugNode: (
  nativeNode: any,
) => DebugNode | null = getDebugNode__PRE_R3__;
