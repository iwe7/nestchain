    ...
    get: () => {
      ...
      if (ngComponentDef === null) {
        ...
        const meta: R3ComponentMetadataFacade = {
          ...
          viewQueries: extractQueriesMetadata(
            type,
            getReflect().propMetadata(type),
            isViewQuery,
          ),
          directives: [],
        ...
        ngComponentDef = compiler.compileComponent(
          angularCoreEnv,
          `ng://${stringify(type)}/template.html`,
          meta,
        );
    ...
    get: () => {
      if (ngDirectiveDef === null) {
        ...
        ngDirectiveDef = getCompilerFacade().compileDirective(
          angularCoreEnv,
          `ng://${type && type.name}/ngDirectiveDef.js`,
          facade,
        );
      }
...
export function convertToR3QueryMetadata(
  propertyName: string,
  ann: Query,
): R3QueryMetadataFacade {
  return {
