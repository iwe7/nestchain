...
export function isComponentInstance(instance: any): boolean {
  return (
    instance && instance.constructor && instance.constructor.ngComponentDef
  );
}

export function isDirectiveInstance(instance: any): boolean {
  return (
    instance && instance.constructor && instance.constructor.ngDirectiveDef
  );
}
...
export function getDirectivesAtNodeIndex(
  ...
  if (!includeComponents && tNode.flags & TNodeFlags.isComponent)
    directiveStartIndex++;
  return lView.slice(directiveStartIndex, directiveEndIndex);
}

export function getComponentAtNodeIndex(
  nodeIndex: number,
  lView: LView,
): {} | null {
  const tNode = lView[TVIEW].data[nodeIndex] as TNode;
 ...
 */
export function discoverLocalRefs(
  lView: LView,
  nodeIndex: number,
): { [key: string]: any } | null {
  const tNode = lView[TVIEW].data[nodeIndex] as TNode;
