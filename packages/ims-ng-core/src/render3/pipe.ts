...
export function pipe(index: number, pipeName: string): any {
  ...
  if (tView.firstTemplatePass) {
    ...
    if (pipeDef.onDestroy) {
      (tView.pipeDestroyHooks || (tView.pipeDestroyHooks = [])).push(
        adjustedIndex,
        pipeDef.onDestroy,
      );
    }
...
export function pipeBind1(index: number, slotOffset: number, v1: any): any {
  ...
  return unwrapValue(
    isPure(index)
      ? pureFunction1(slotOffset, pipeInstance.transform, v1, pipeInstance)
...
export function pipeBind2(
  ...
  return unwrapValue(
    isPure(index)
      ? pureFunction2(slotOffset, pipeInstance.transform, v1, v2, pipeInstance)
...
export function pipeBindV(
  ...
  return unwrapValue(
    isPure(index)
      ? pureFunctionV(slotOffset, pipeInstance.transform, values, pipeInstance)
