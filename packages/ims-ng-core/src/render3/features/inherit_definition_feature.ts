 ...
 */
function isComponentDef<T>(
  definition: ComponentDef<T> | DirectiveDef<T>,
...
function getSuperType(
  ...
  ngDirectiveDef?: DirectiveDef<any>;
} {
    ...
    if (superDef) {
      ...
      if (superContentQueriesRefresh) {
        if (prevContentQueriesRefresh) {
          definition.contentQueriesRefresh = (
      ...
      if (superPrototype) {
        ...
        definition.afterViewInit =
          definition.afterViewInit || superPrototype.afterViewInit;
