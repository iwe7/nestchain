...
export {
  APP_ID_RANDOM_PROVIDER as ɵAPP_ID_RANDOM_PROVIDER,
...
export {
  isListLikeIterable as ɵisListLikeIterable,
} from './change_detection/change_detection_util';
export {
...
export {
  InjectableDef as ɵInjectableDef,
  InjectorDef as ɵInjectorDef,
...
export {
  ComponentFactory as ɵComponentFactory,
} from './linker/component_factory';
export {
  CodegenComponentFactoryResolver as ɵCodegenComponentFactoryResolver,
...
export {
  _sanitizeStyle as ɵ_sanitizeStyle,
} from './sanitization/style_sanitizer';
export { _sanitizeUrl as ɵ_sanitizeUrl } from './sanitization/url_sanitizer';
export {
  global as ɵglobal,
  looseIdentical as ɵlooseIdentical,
