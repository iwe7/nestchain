import { Provider, InjectionToken, Injector, ErrorSubject } from 'ims-core';
...
export const CompilerOptionsToken = new InjectionToken<ts.CompilerOptions>(
  'CompilerOptionsToken',
);
