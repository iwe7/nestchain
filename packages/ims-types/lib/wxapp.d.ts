...
declare namespace WeApp {
  ...
  interface wx {
    ...
    getBackgroundAudioPlayerState(
      param: GetBackgroundAudioPlayerStateParam,
    ): void;
    /**播放音乐 */
    ...
    /**关闭当前页面 回退前一页面 */
    navigateBack(param?: {
      /**返回的页面数 如果 delta 大于现有页面数 则返回到首页 默认1 */ delta: number;
    }): void;
    /**动画 */
    ...
    onBluetoothAdapterStateChange(
      param: BluetoothAdapterStateChangeParam,
    ): void;
    /**开始搜寻附近的蓝牙外围设备 */
    ...
    onBluetoothDeviceFound(
      callback: (devices: Array<BluetoothDevice>) => void,
    ): void;
    ...
    notifyBLECharacteristicValueChange(
      param: BLECharacteristicValueChangedParam,
    ): void;
    ...
    onBeaconServiceChange(
      callback: (
        res: {
          /**服务目前是否可用 */ available: boolean;
          /**目前是否处于搜索状态 */ discovering: boolean;
        },
      ) => void,
    ): void;
    ...
    checkIsSoterEnrolledInDevice(
      param: CheckIsSoterEnrolledInDeviceParam,
    ): never;
    /**
     * @since 1.5.0
  ...
  interface FileInfoParam extends CallbackParam {
    ...
    filePath: string;
    success?: (
      res?: { errMsg: string; size: number; createTime: number },
    ) => void;
  }
  ...
  interface NetworkTypeParam extends CallbackParam {
    success: (
      res?: { /**返回网络类型2g|3g|4g|wifi */ networkType: string },
    ) => void;
  }
  ...
  interface ConnectedBluetoothDevicesParam extends CallbackParam {
    ...
    success: (
      res: {
        devices: Array<{
          /**蓝牙设备名称 某些设备可能没有 */ name: string;
          /**用于区分设备的 id */ deviceId: string;
        }>;
        /**成功：ok 错误：详细信息 */ errMsg: string;
      },
    ) => void;
  ...
  interface BLEDeviceServicesParam extends CallbackParam {
    ...
    success: (
      res: {
        services: Array<{
          /**蓝牙设备服务的 uuid */ uuid: string;
          /**该服务是否为主服务 */ isPrimary: boolean;
        }>;
        /**成功：ok 错误：详细信息 */ errMsg: string;
      },
    ) => void;
  ...
  interface NodesRef {
    ...
    boundingClientRect(
      callback: (rect: WxClientRect | Array<WxClientRect>) => void,
    ): SelectorQuery;
